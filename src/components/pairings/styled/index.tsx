...
import { View, Text, TouchableOpacity, ViewStyle, TextStyle, TouchableOpacityProps, ViewProps, TextProps, Platform } from 'react-native';
import * as Haptics from 'expo-haptics';
import { usePairingTheme } from '@/src/theme/pairingTheme';

export const Box = ({ style, ...props }: ViewProps) => {
      ...
      {tabs.map((tab) => {
        ...
        return (
          <TouchableOpacity
            ...
            onPress={() => {
              // Haptic feedback only works on native platforms (iOS/Android)
              if (Platform.OS !== 'web') {
